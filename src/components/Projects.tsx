      ...
      <div className="grid grid-cols-2 h-[360px] mt-48">
        ...
        <div className="">
          ...
          >
            ...
            gebruik voor het bouwen van de UI en interactieve elementen. Het design is zelf ontworpen en
            met behulp van Tailwind.css is de website geheel responsief op alle
            apparaten
          </p>
          {/* links */}
          <div className="flex  gap-10">
